package me.elmajni.SharedPreferencesExample1;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.seekBarBrightness=
                (SeekBar)this.findViewById(R.id.seekBar_brightness);
        ...
        this.radioGroupDiffLevel= (RadioGroup)
                this.findViewById(R.id.radioGroup_diffLevel);
        this.radioButtonEasy=(RadioButton)
                this.findViewById(R.id.radioButton_easy);
        this.radioButtonMedium =
                (RadioButton)this.findViewById(R.id.radioButton_medium);
        this.radioButtonHard=(RadioButton)
                this.findViewById(R.id.radioButton_hard);
    ...
    private void loadGameSetting() {
        SharedPreferences sharedPreferences=
                this.getSharedPreferences("gameSetting", Context.MODE_PRIVATE);
    ...
    public void doSave(View view) {
        ...
        int checkedRadioButtonId =
                radioGroupDiffLevel.getCheckedRadioButtonId();
